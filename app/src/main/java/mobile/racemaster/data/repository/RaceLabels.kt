 ...
 *  blank now (the course concept was dropped in phase 1 — a race's name may carry its own
 *  Seniors/Juniors suffix as plain text instead), in which case its segment is omitted entirely
 *  rather than leaving a bare double-hyphen in the label. */
